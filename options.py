...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--model', type=str, default='res_cls',
                            help='[res_cls], see model.__init__ from more details.')
        parser.add_argument('--solver', type=str, default='res_cls',
                            help='[res_cls], see solvers.__init__ for more details.')
        parser.add_argument('--optim_policy', type=str, default='adam', help='optim policy: adam|sgd|rmsprop')
        parser.add_argument('--cls_backend', type=str, default='inception',
                            help='cls base network: default|inception|resnet50|resnet152|densenet121')
        parser.add_argument('--backend_pretrain', action='store_true',
                            help='if specified, use imagenet pretrained for backend.')

        parser.add_argument('--lucky_seed', type=int, default=0,
        ...
        parser.add_argument('--cls_pkl', type=str, default="emotion_labels.pkl",
                            help='emotion labels pickle dictionary.')
        ...
        parser.add_argument('--load_model_dir', type=str, default='./checkpoints',
                            help='directory to load pretrained model.')
        ...
        parser.add_argument('--norm', type=str, default='instance',
                            help='instance normalization or batch normalization [batch|instance|none]')
        ...
        parser.add_argument('--use_cls_dropout', action='store_true',
                            help='if specified, use dropout for classifier net.')
        parser.add_argument('--cls_norm', type=str, default='batch',
                            help='instance normalization or batch normalization [batch|instance|none]')
        parser.add_argument('--log_file', type=str, default="losses.log", help='log loss')

        # residual face net option
        parser.add_argument('--res_use_dropout', action='store_true',
                            help='if specified, use dropout for residual face generating net.')
        parser.add_argument('--res_norm', type=str, default='batch',
                            help='instance normalization or batch normalization [batch|instance|none]')
        parser.add_argument('--res_n_blocks', type=int, default=4, help='residual block number for resface net.')
        parser.add_argument('--sample_img_freq', type=int, default=5,
                            help='sample train image for every sample_img_freq step.')
        parser.add_argument('--res_lr', type=float, default=1e-5,
                            help='initial learning rate for adam for resface gen net.')

        # frequency options
        parser.add_argument('--batch_size', type=int, default=32, help='input batch size.')
        parser.add_argument('--print_losses_freq', type=int, default=4, help='print log every print_losses_freq step.')
        parser.add_argument('--save_epoch_freq', type=int, default=200,
                            help='save checkpoint every save_epoch_freq epoch.')
